        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('blogs.update', $blog->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ $blog->name }}"/>
                       @if($errors->has("name"))
                    ...
                    <input type="text" id="slug-field" name="slug" class="form-control" value="{{ $blog->slug }}"/>
                       @if($errors->has("slug"))
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ $blog->description }}</textarea>
                    ...
                    <input type="text" id="cover-field" name="cover" class="form-control" value="{{ $blog->cover }}"/>
                       @if($errors->has("cover"))
                    ...
                    <input type="text" id="user_id-field" name="user_id" class="form-control" value="{{ $blog->user_id }}"/>
                    ...
                    <input type="text" id="article_count-field" name="article_count" class="form-control" value="{{ $blog->article_count }}"/>
                    ...
                    <input type="text" id="subscriber_count-field" name="subscriber_count" class="form-control" value="{{ $blog->subscriber_count }}"/>
                    ...
                    <input type="text" id="is_recommended-field" name="is_recommended" class="form-control" value="{{ $blog->is_recommended }}"/>
                    ...
                    <input type="text" id="is_blocked-field" name="is_blocked" class="form-control" value="{{ $blog->is_blocked }}"/>
