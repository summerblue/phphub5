      ...
      <div class="container">
        <div class="row footer-top">
          ...
          <div class="col-sm-5 col-lg-5">
              <h4>
                  <img src="http://phphub5.app/assets/images/banner_transparent.png" alt="" width="160"/>
              </h4>
          ...
          <div class="col-sm-6 col-lg-6 col-lg-offset-1">
              ...
              <div class="row">
                <div class="col-xs-3">
                  ...
                  <div class="col-xs-3">
                      <h4>微信订阅号</h4>
                    <img class="image-border popover-with-html" data-content="扫码，或者搜索微信订阅号：PHPHub" src="https://dn-phphub.qbox.me/uploads/images/201607/19/1/5KAh3F8EhD.jpg" style="width:120px;">
                  </div>
