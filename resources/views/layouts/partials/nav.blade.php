  ...
  <div class="container">
    ...
    <div id="top-navbar-collapse" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="{{ Request::is('categories/'.config('phphub.life_category_id')) ? ' active' : '' }}"><a href="{{ route('categories.show', config('phphub.life_category_id')) }}">生活</a></li>
        ...
        <li ><a href="https://laravel-china.org/news" class="no-pjax">资讯</a></li>
